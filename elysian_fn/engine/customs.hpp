...
namespace elysian_fn {
	namespace customs {
		...
		bool in_rect(double centerX, double centerY, double radius, double x, double y) {
			return x >= centerX - radius && x <= centerX + radius &&
				y >= centerY - radius && y <= centerY + radius;
		}

		bool in_circle(double centerX, double centerY, double radius, double x, double y) {
			if (in_rect(centerX, centerY, radius, x, y)) {
				double dx = centerX - x;
				double dy = centerY - y;
				dx *= dx;
				dy *= dy;
